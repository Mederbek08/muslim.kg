    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="e bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto items-center relative">
              {alert && (
                <Alert
              ...
              <div className="grid md:grid-cols-2 gap-8 p-8">
                ...
                >
                  ...
                  <button
                    ...
                    disabled={stock === 0}
                    className="w-full py-4 bg-gradient-to-r from-green-600 to-blue-500 text-white font-bold text-lg rounded-xl shadow-lg hover:shadow-xl transition duration-200 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105 active:scale-95"
                  >
  ...
  return (
    <>
      <motion.div
        ...
        className="relative w-full rounded-2xl shadow-xl bg-gradient-to-r from-green-600 to-blue-500 p-0.5 cursor-pointer"
      >
        <AnimatePresence>
          {alert && (
            <Alert
        ...
        <div className="p-6 rounded-2xl bg-white bg-opacity-10 backdrop-blur-lg flex flex-col space-y-4 h-full text-white">
            ...
            <div className="flex flex-col items-end">
              ...
              <p
                className={`text-lg font-bold ${
                  inStock ? "text-green-300" : "text-red-300"
                }`}
              >
                {stock} шт
              </p>
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="w-full py-3 mt-4 bg-white text-green-600 font-bold text-base md:text-lg rounded-lg shadow-lg hover:shadow-xl transition duration-200 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed"
